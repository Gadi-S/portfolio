...
|--------|-------------|------------|--------------|--------------|
| Project1-EDA | **Data preprocessing** and exhaustive **EDA** (univariate and bivariate) on data for a food aggregator company with **business recommendations** | pandas, numpy, matplotlib, seaborn | [Notebook](docs/projects/project1-EDA/Gadiel_Shepherd_Full_Code.ipynb) | Grade: 60/60  [View Feedback](#project-1-EDA) |
